...
rule ("Mechanic | Climbers | Bhop count for stand ban") {
    ...
    actions {
        ...
        If(And(Compare((Event Player).skill_countBhops, >, 1), Not((Event Player).toggle_invincible)));
            ...
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Stand Createbhop ♠ Is Banned!   Stand Createbhop ♠ Is Banned!   Stand Createbhop ♠ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(Белый), Empty Array)))));
            Call Subroutine(CheckpointFailReset);
    }
}
...
rule ("Mechanic | Climbers | Create Bhop") {
    ...
    actions {
        ...
        If(And((Event Player).ban_create, Not((Event Player).toggle_invincible)));
            ...
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Create Bhop ♂ Is Banned!   Create Bhop ♂ Is Banned!   Create Bhop ♂ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(Белый), Empty Array)))));
            Call Subroutine(CheckpointFailReset);
        Else;
            ...
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Bhop Created!   Bhop Created!   Bhop Created!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(Белый), Empty Array)))));
    }
}
    ...
    actions {
        ...
        Else;
            If(And(And((Event Player).ban_multi, (Event Player).checkpoint_notLast), Not((Event Player).toggle_invincible)));
                ...
                Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Multiclimb ∞ Is Banned!   Multiclimb ∞ Is Banned!   Multiclimb ∞ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(Белый), Empty Array)))));
                Call Subroutine(CheckpointFailReset);
            Else;
...
rule ("Mechanic | Genji | Ban Save Double - 封禁二段跳") {
    ...
    actions {
        ...
        Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Save Double Banned!   Save Double Banned!   Save Double Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(Белый), Empty Array)))));
        Call Subroutine(CheckpointFailReset);
    }
}
...
rule ("Editor | Hud & Effects") {
    ...
    actions {
        ...
        If(Global.EditorOn);
            ...
            "Teleport text"
            Create In-World Text(If-Then-Else(And(Compare(Count Of(Value In Array(Global.A, (Host Player).checkpoint_current)), >, 1), Not((Host Player).editor_modeSelect)), Host Player, Null), If-Then-Else(Compare(String("Ох"), ==, Custom String("噢")), Custom String("传送点位置"), Custom String("teleporter location")), Value In Array(Value In Array(Global.A, (Host Player).checkpoint_current), True), 1.6, Do Not Clip, Visible To Position and String, Color(Sky Blue), Default Visibility);
...
rule ("Huds | Leaderboard") {
    ...
    actions {
        ...
        If(Value In Array(Global.LeaderBoardFull, True));
            Create HUD Text(First Of(True), Hero Icon String(Hero(Гэндзи)), First Of(Value In Array(Global.LeaderBoardFull, True)), Last Of(Value In Array(Global.LeaderBoardFull, True)), Right, -139, Color(Orange), Color(Orange), Color(Orange), Visible To, Visible Always);
            Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
            If(Value In Array(Global.LeaderBoardFull, 2));
                Create HUD Text(First Of(True), Hero Icon String(Hero(Гэндзи)), First Of(Value In Array(Global.LeaderBoardFull, 2)), Last Of(Value In Array(Global.LeaderBoardFull, 2)), Right, -138, Color(Yellow), Color(Yellow), Color(Yellow), Visible To, Visible Always);
                Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
                If(Value In Array(Global.LeaderBoardFull, 3));
                    Create HUD Text(First Of(True), Hero Icon String(Hero(Гэндзи)), First Of(Value In Array(Global.LeaderBoardFull, 3)), Last Of(Value In Array(Global.LeaderBoardFull, 3)), Right, -137, Color(Lime Green), Color(Lime Green), Color(Lime Green), Visible To, Visible Always);
                    Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
                    If(Value In Array(Global.LeaderBoardFull, 4));
                        Create HUD Text(First Of(True), Hero Icon String(Hero(Гэндзи)), First Of(Value In Array(Global.LeaderBoardFull, 4)), Last Of(Value In Array(Global.LeaderBoardFull, 4)), Right, -136, Color(Green), Color(Green), Color(Green), Visible To, Visible Always);
                        Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
                    End;
                End;
            End;
