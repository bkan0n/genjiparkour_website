// framework-template_ko-KR.js (auto)
export const frameworkTemplate = `settings
{
	main
	{
		모드 이름: "Genji Parkour - 源氏跑酷 - v1.10.4A"
        ...
        While(Global.TimeRemaining);
            ...
            If(Global.CompMode);
                ...
                If(Not(Global.CompTime));
                    Big Message(First Of(True), If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("时间到了"), Custom String("Time's Up")));
...
rule ("Parkour | Player Initialize") {
    ...
    action {
        ...
        Preload Hero(Event Player, Hero(겐지));
    ...
    action {
        ...
        Else If(Compare(Distance Between(Event Player, Value In Array(Global.A, Add((Event Player).checkpoint_current, True))), <=, 1.4));
            ...
            Else If(And((Event Player).ban_climb, (Event Player).skill_usedClimb));
                ...
                Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Climb ↑ Is Banned!   Climb ↑ Is Banned!   Climb ↑ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
                Call Subroutine(CheckpointFailReset);
    ...
    action {
        ...
        If(Compare((Event Player).cache_bounceTouched, >=, Null));
            If(Value In Array(Global.BounceToggleLock, (Event Player).cache_bounceTouched));
                ...
                Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Collected Orb   Collected Orb   Collected Orb"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
            End;
            ...
            Else If(Compare(Value In Array(Global.EditMode, (Event Player).cache_bounceTouched), <, Null));
                ...
                Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   » Double Jump Is Ready   » Double Jump Is Ready   » Double Jump Is Ready"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
            End;
            If(Value In Array(Global.TQ5, (Event Player).cache_bounceTouched));
                Set Ultimate Ability Enabled(Event Player, True);
                Set Ultimate Charge(Event Player, 100);
                "\\"终极技能已就绪\\" checkCN \\"Ultimate is ready\\""
                Small Message(Event Player, Custom String("   {0} {1}", Ability Icon String(Hero(겐지), Button(Ultimate)), Value In Array(String Split(Custom String("ＴＬＥｒｒUltimate Is ReadyUltimate Is ReadyUltimate Is Ready"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))));
            End;
            If(Value In Array(Global.TQ6, (Event Player).cache_bounceTouched));
                ...
                Small Message(Event Player, Custom String("   {0} {1}", Ability Icon String(Hero(겐지), Button(Ability 1)), Value In Array(String Split(Custom String("ＴＬＥｒｒDash Is ReadyDash Is ReadyDash Is Ready"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))));
            End;
...
rule ("Parkour | SUB Update Effect Cache") {
    event {
        Subroutine;
        UpdateCache;
    }
    action {
        ...
        Create Effect(If-Then-Else((Host Player).editor_hitboxToggle, Host Player, Null), Sphere, Color(흰색), Value In Array(Global.A, (Host Player).checkpoint_current), 1.4, Visible To Position and Radius);
        Set Player Variable(Host Player, editor_hitboxEffect, Last Created Entity);
        Create Effect(If-Then-Else(And((Host Player).editor_hitboxToggle, (Host Player).checkpoint_notLast), Host Player, Null), Sphere, Color(흰색), Value In Array(Global.A, Add((Host Player).checkpoint_current, True)), 1.4, Visible To Position and Radius);
...
rule ("Parkour | SUB Leaderboard Update") {
    event {
        Subroutine;
        LeaderboardUpdate;
    }
...
rule ("Parkour | SUB Checkpoint Fail") {
    event {
        Subroutine;
        CheckpointFailReset;
    }
...
rule ("Mechanic | All | Jump") {
    ...
    action {
        ...
        If((Event Player).skill_usedHop);
            "\\"   小跳已用\\" checkCN \\"   Bhop\\""
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Bhop   Bhop   Bhop"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
        Else;
...
rule ("Mechanic | All | Emote") {
    ...
    action {
        ...
        If((Event Player).ban_emote);
            ...
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Emote Savehop ♥ Is Banned!   Emote Savehop ♥ Is Banned!   Emote Savehop ♥ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
            Wait(False, Ignore Condition);
            Call Subroutine(CheckpointFailReset);
    }
}
...
rule ("Mechanic | Climbers | Bhop count for stand ban") {
    ...
    action {
        ...
        If(And(Compare((Event Player).skill_countBhops, >, 1), Not((Event Player).toggle_invincible)));
            ...
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Stand Createbhop ♠ Is Banned!   Stand Createbhop ♠ Is Banned!   Stand Createbhop ♠ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
            Call Subroutine(CheckpointFailReset);
    }
}
...
rule ("Mechanic | Climbers | Create Bhop") {
    ...
    action {
        ...
        If(And((Event Player).ban_create, Not((Event Player).toggle_invincible)));
            ...
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Create Bhop ♂ Is Banned!   Create Bhop ♂ Is Banned!   Create Bhop ♂ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
            Call Subroutine(CheckpointFailReset);
        Else;
            ...
            Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Bhop Created!   Bhop Created!   Bhop Created!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
    }
}
    ...
    action {
        ...
        Else;
            If(And(And((Event Player).ban_multi, (Event Player).checkpoint_notLast), Not((Event Player).toggle_invincible)));
                ...
                Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Multiclimb ∞ Is Banned!   Multiclimb ∞ Is Banned!   Multiclimb ∞ Is Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
                Call Subroutine(CheckpointFailReset);
            Else;
...
rule ("Mechanic | Genji | SUB Check Ultimate") {
    event {
        Subroutine;
        CheckUlt;
    }
...
rule ("Mechanic | Genji | SUB Check Dash") {
    event {
        Subroutine;
        CheckAbility1;
    }
...
rule ("Mechanic | Genji | Ban Save Double - 封禁二段跳") {
    ...
    action {
        ...
        Small Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒ   Save Double Banned!   Save Double Banned!   Save Double Banned!"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
        Call Subroutine(CheckpointFailReset);
    }
}
...
rule ("Editor | Export Map") {
    ...
    action {
        ...
        Create HUD Text(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("    > 按互动键关闭当前窗口 <    "), Custom String("    > Press Interact To Close This Window <    ")), Null, Null, Top, -183, Color(Lime Green), Null, Null, String, Default Visibility);
...
rule ("Editor | Hud & Effects") {
    ...
    action {
        ...
        If(Global.EditorOn);
            ...
            "Teleport text"
            Create In-World Text(If-Then-Else(And(Compare(Count Of(Value In Array(Global.A, (Host Player).checkpoint_current)), >, 1), Not((Host Player).editor_modeSelect)), Host Player, Null), If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("传送点位置"), Custom String("teleporter location")), Value In Array(Value In Array(Global.A, (Host Player).checkpoint_current), True), 1.6, Do Not Clip, Visible To Position and String, Color(Sky Blue), Default Visibility);
            ...
            Create In-World Text(If-Then-Else(And(Value In Array(Value In Array(Global.A, (Host Player).checkpoint_current), True), Not((Host Player).editor_modeSelect)), Host Player, Null), If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("检查点位置"), Custom String("level location")), First Of(Value In Array(Global.A, (Host Player).checkpoint_current)), 1.6, Do Not Clip, Visible To Position and String, Color(Sky Blue), Default Visibility);
            "portal fx"
    ...
    action {
        ...
        If(Not((Host Player).editor_modeSelect));
            If(And(Count Of(Global.A), Compare(Distance Between(Host Player, Value In Array(Global.A, (Host Player).checkpoint_current)), <=, 1.4)));
                Small Message(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   放置的检查点距离太近"), Custom String("   Cannot Place Checkpoint Too Close.")));
            Else;
                "$$"
                ...
                End;
                Call Subroutine(UpdateCache);
                Small Message(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   新检查点已创建"), Custom String("   New Checkpoint Created")));
            End;
        Else If(Not(Count Of(Global.A)));
            Small Message(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   请先放置检查点"), Custom String("   Make A Checkpoint First")));
        Else If(Compare(Add(Add(Count Of(Global.TQ), Count Of(Global.H)), Count Of(Global.CustomPortalStart)), >=, 193));
            Big Message(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("当前地图弹球/传送门数量已达上限"), Custom String("Orb/Portal Limit Reached For This Map")));
        Else If(Compare((Host Player).editor_modeSelect, ==, 1));
            ...
            Big Message(First Of(True), Custom String("{0} {1}", If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("新击杀球已创建! \\n仅生效于检查点"), Custom String("New boundary Sphere Created! \\nOnly Valid For This Checkpoint")), (Host Player).checkpoint_current));
        ...
        Else If(Compare((Host Player).editor_modeSelect, ==, 2));
            ...
            Big Message(First Of(True), Custom String("{0} {1}", If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("新弹球已创建! \\n仅生效于检查点"), Custom String("New Bounce Orb Created! \\nOnly Valid For This Checkpoint")), (Host Player).checkpoint_current));
            Wait Until(Not(And(Is Button Held(Host Player, Button(Interact)), Is Button Held(Host Player, Button(Primary Fire)))), True);
            While(And(Is Button Held(Host Player, Button(Interact)), Is Button Held(Host Player, Button(Primary Fire))));
        ...
        Else If(Compare((Host Player).editor_modeSelect, ==, 4));
            ...
            While(And(Is Button Held(Host Player, Button(Interact)), Is Button Held(Host Player, Button(Primary Fire))));
                ...
                Wait(False, Ignore Condition);
            End;
            Big Message(First Of(True), If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("新传送门已创建!\\n生效于当前检查点"), Custom String("Portal Created \\nOnly Valid For This Checkpoint")));
            Set Global Variable(EditorMoveItem, True);
        End;
        Set Player Variable(Host Player, editor_lock, False);
        Wait(0.64, Ignore Condition);
...
rule ("Editor | Delete Cp/Orb/Portal") {
    ...
    action {
        ...
        If(And(Not((Host Player).editor_modeSelect), Count Of(Global.A)));
            ...
            Small Message(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   检查点已删除"), Custom String("   Checkpoint Has Been Deleted")));
...
rule ("Editor | Cp Add/Remove Teleport") {
    ...
    action {
        ...
        If(Not((Host Player).checkpoint_current));
            Small Message(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   不能在第一个检查点设置传送门"), Custom String("   Cannot Place A Teleport On First Checkpoint")));
            Set Player Variable(Host Player, editor_lock, False);
            Abort;
        End;
        "remove"
        If(Compare(Count Of(Value In Array(Global.A, (Host Player).checkpoint_current)), >, 1));
            ...
            Small Message(Host Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   关卡{0}的传送点已移除", (Host Player).checkpoint_current), Custom String("   Teleport For Level {0} Has Been Removed", (Host Player).checkpoint_current)));
        "add"
        Else;
            ...
            Small Message(Host Player, Custom String("{0} {1}", If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   传送点已添加到当前关卡"), Custom String("   Teleport Has Been Added For Level")), (Host Player).checkpoint_current));
        End;
        Set Player Variable(Host Player, editor_lock, False);
        Wait(False, Ignore Condition);
    }
...
rule ("Command | Toggle Invisible (Hold Deflect)") {
    ...
    action {
        ...
        If((Event Player).toggle_invisible);
            Set Invisible(Event Player, All);
        End;
        Small Message(Event Player, Custom String("  {0}{1}", Value In Array(String Split(Custom String("ＴＬＥｒｒInvisibleInvisibleInvisible"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), If-Then-Else((Event Player).toggle_invisible, Value In Array(String Split(Custom String("ＴＬＥｒｒ | On | On | On"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Value In Array(String Split(Custom String("ＴＬＥｒｒ | Off | Off | Off"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))))));
    ...
    action {
        ...
        If(Global.CompMode);
            ...
            If(Compare(Global.CompTime, <, 1));
                Small Message(Event Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   比赛结束"), Custom String("   Competition Is Over")));
                Set Player Variable(Event Player, lockState, False);
                Abort;
            ...
            Else If(And(Global.CompRestartLimit, (Event Player).checkpoint_notLast));
                Small Message(Event Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   禁止在此比赛中运行期间重新启动"), Custom String("   Restart During Run Is Disabled For This Competition")));
                Set Player Variable(Event Player, lockState, False);
                Abort;
            Else If(Global.CompAtmpNum);
                If(Compare((Event Player).comp_countAttempts, ==, Global.CompAtmpNum));
                    Small Message(Event Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   最后一次尝试"), Custom String("   This Is Your Final Attempt")));
                    Set Player Variable(Event Player, lockState, False);
                    Abort;
                End;
                If(Compare((Event Player).comp_countAttempts, <, Null));
                    Small Message(Event Player, If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("   你没有尝试过"), Custom String("   You Are Out Of Attempts")));
                    Set Player Variable(Event Player, lockState, False);
                    Abort;
                End;
...
rule ("Command | Toggle Invincible Mode (Melee + Reload)") {
    ...
    action {
        ...
        If((Event Player).toggle_invincible);
            ...
            Big Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒInvincible ModeInvincible ModeInvincible Mode"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
            Call Subroutine(TimerPause);
            Stop Chasing Player Variable(Event Player, timer_practice);
            Start Rule(CheckUlt, Do Nothing);
            Start Rule(CheckAbility1, Do Nothing);
        Else;
            If((Event Player).toggle_practice);
                ...
                Big Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒPractice ModePractice ModePractice Mode"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
                Chase Player Variable At Rate(Event Player, timer_practice, 999999999999, True, None);
                Call Subroutine(CheckpointFailReset);
            Else If((Event Player).checkpoint_notLast);
                "\\"跑图模式\\" checkCN \\"Normal mode\\""
                Big Message(Event Player, Value In Array(String Split(Custom String("ＴＬＥｒｒNormal ModeNormal ModeNormal Mode"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))));
                Call Subroutine(TimerResume);
                Call Subroutine(CheckpointFailReset);
            End;
        End;
...
rule ("Huds | Global Localplayer") {
    ...
    action {
        ...
        If(Not(Global.EditorOn));
            Create HUD Text(First Of(True), Null, If-Then-Else((Local Player).toggle_guide, Custom String("Discord: dsc.gg/genjiparkour"), Empty Array), Custom String("{0}: {1}                                                                                                ", Value In Array(String Split(Custom String("ＴＬＥｒｒMade ByMade ByMade By"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Global.Name), Left, -200, Null, Value In Array(Global.ColorConfig, 18), First Of(Global.ColorConfig), Visible To and String, Default Visibility);
            Create HUD Text(First Of(True), Null, Null, Custom String("{0}: {1}                                                                                                ", Value In Array(String Split(Custom String("ＴＬＥｒｒMap CodeMap CodeMap Code"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Global.Code), Left, -199, Null, Null, Value In Array(Global.ColorConfig, True), Visible To and String, Default Visibility);
            Create HUD Text((Local Player).toggle_guide, Null, Null, Custom String("{0} {1} + {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒHoldHoldHold"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Primary Fire)), Custom String("{0} | {1}", Input Binding String(Button(Secondary Fire)), Value In Array(String Split(Custom String("ＴＬＥｒｒPreview CPPreview CPPreview CP"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))))), Right, -160, Null, Null, If-Then-Else((Local Player).preview_array1, Evaluate Once(Value In Array(Global.ColorConfig, 6)), Evaluate Once(Value In Array(Global.ColorConfig, 5))), Visible To String and Color, Default Visibility);
            Create HUD Text(First Of(And((Local Player).preview_array1, (Local Player).toggle_guide)), Null, Value In Array(String Split(Custom String("ＴＬＥｒｒWalk ◀ ▶ | Preview Others\\nWalk ▲ ▼ | Modify Zoom\\nAim | Change Preview AngleWalk ◀ ▶ | Preview Others\\nWalk ▲ ▼ | Modify{0}", Custom String(" Zoom\\nAim | Change Preview AngleWalk ◀ ▶ | Preview Others\\nWalk ▲ ▼ | Modify Zoom\\nAim | Change Preview Angle")), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Null, Top, -171, Null, Value In Array(Global.ColorConfig, 6), Null, Visible To and String, Visible Never);
            Create HUD Text(Local Player, Null, Null, If-Then-Else(Or(Compare((Local Player).timer_splitDisplay, <=, -999999999999), (Local Player).toggle_spectate), Empty Array, Custom String("{0}{1}                                                                                                ", Value In Array(String Split(Custom String("ＴＬＥｒｒSplit: Split: Split: "), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), (Local Player).timer_splitDisplay)), Left, -195, Null, Null, Value In Array(Global.ColorConfig, 3), Visible To and String, Default Visibility);
            "Remove no hints - visual and element bloat"
            If(Count Of(Global.HintText));
                Create HUD Text(First Of(And((Local Player).toggle_guide, Array Contains(Global.HintCp, (Local Player).checkpoint_current))), Null, Custom String("{0}{1}", If-Then-Else((Local Player).toggle_hints, Value In Array(String Split(Custom String("ＴＬＥｒｒ― ― ― ― ― Hint ― ― ― ― ―\\n― ― ― ― ― Hint ― ― ― ― ―\\n― ― ― ― ― Hint ― ― ― ― ―\\n"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Value In Array(String Split(Custom String("ＴＬＥｒｒ― ― ― Hint Available ― ― ―― ― ― Hint Available ― ― ―― ― ― Hint Available ― ― ―"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))), If-Then-Else((Local Player).toggle_hints, Value In Array(Global.HintText, Index Of Array Value(Global.HintCp, (Local Player).checkpoint_current)), Empty Array)), Custom String("{0} + {1} | {2}", Input Binding String(Button(Ability 2)), Input Binding String(Button(Melee)), If-Then-Else((Local Player).toggle_hints, Value In Array(String Split(Custom String("ＴＬＥｒｒHide HintHide HintHide Hint"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Value In Array(String Split(Custom String("ＴＬＥｒｒShow HintShow HintShow Hint"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))))), Right, -151, Null, If-Then-Else((Local Player).toggle_hints, Color(Green), Color(Orange)), If-Then-Else(Array Contains(Global.HintCp, (Local Player).checkpoint_current), Evaluate Once(Value In Array(Global.ColorConfig, 5)), Color(회색)), Visible To String and Color, Default Visibility);
            End;
            Create HUD Text((Local Player).toggle_guide, Null, Null, Custom String("{0} + {1} + {2}", Input Binding String(Button(Crouch)), Input Binding String(Button(Ability 2)), Custom String("{0} | {1}\\n{2}", Input Binding String(Button(Interact)), Value In Array(String Split(Custom String("ＴＬＥｒｒRestartRestartRestart"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Custom String("{0} {1} | {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒHoldHoldHold"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Melee)), Value In Array(String Split(Custom String("ＴＬＥｒｒLeaderboardLeaderboardLeaderboard"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))))), Right, -156, Null, Null, Value In Array(Global.ColorConfig, 5), Visible To and String, Default Visibility);
            ...
            If(Compare(First Of(Global.Difficultyhud), !=, 17));
                Create HUD Text(First Of(And((Local Player).toggle_guide, Not((Local Player).toggle_leaderboard))), If-Then-Else(Last Of(Global.Difficultyhud), Value In Array(String Split(Custom String("ＴＬＥｒｒPlaytestPlaytestPlaytest"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Empty Array), Value In Array(Array(Custom String("Playtest"), Custom String("Easy -"), Custom String("Easy"), Custom String("Easy +"), Custom String("Medium -"), Custom String("Medium"), Custom String("Medium +"), Custom String("Hard -"), Custom String("Hard"), Custom String("Hard +"), Custom String("Very Hard -"), Custom String("Very Hard"), Custom String("Very Hard +"), Custom String("Extreme -"), Custom String("Extreme"), Custom String("Extreme +"), Custom String("Hell"), Null), First Of(Global.Difficultyhud)), Null, Top, -173, Color(Blue), Value In Array(Array(Color(Blue), Color(Lime Green), Color(Lime Green), Color(Lime Green), Color(Yellow), Color(Yellow), Color(Yellow), Color(Orange), Color(Orange), Color(Orange), Custom Color(255, 69, 0, 255), Custom Color(255, 69, 0, 255), Custom Color(255, 69, 0, 255), Color(Red), Color(Red), Color(Red), Custom Color(150, 0, 0, 255), Null), First Of(Global.Difficultyhud)), Null, Visible To and String, Default Visibility);
            End;
        End;
        "global huds"
        Create HUD Text(First Of(True), Null, Custom String("{0}{1}{2}", Value In Array(String Split(Custom String("ＴＬＥｒｒServer Restart In Server Restart In Server Restart In "), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Global.TimeRemaining, Custom String("{0}v1.10.4A{1}", Value In Array(String Split(Custom String("ＴＬＥｒｒ Min -  Min -  Min - "), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), If-Then-Else(Compare(Text Count, >=, 128), Value In Array(String Split(Custom String("ＴＬＥｒｒ\\nError: Max HUD Count Reached\\nError: Max HUD Count Reached\\nError: Max HUD Count Reached"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Empty Array))), Null, Right, -162, Null, Value In Array(Global.ColorConfig, 2), Null, Visible To and String, Visible Always);
        ...
        Create HUD Text((Local Player).toggle_guide, Null, Null, If-Then-Else((Local Player).toggle_quickRestart, Custom String("{0} | {1}", Input Binding String(Button(Reload)), Value In Array(String Split(Custom String("ＴＬＥｒｒQuick ResetQuick ResetQuick Reset"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))), Custom String("{0} {1} | {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒHoldHoldHold"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Reload)), Value In Array(String Split(Custom String("ＴＬＥｒｒEnable Quick ResetEnable Quick ResetEnable Quick Reset"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))))), Right, -157, Null, Null, Value In Array(Global.ColorConfig, 5), Visible To and String, Default Visibility);
        Create HUD Text((Local Player).toggle_guide, Null, Null, Custom String("{0} + {1} | {2}", Input Binding String(Button(Reload)), Input Binding String(Button(Melee)), Custom String("{0}{1}", Value In Array(String Split(Custom String("ＴＬＥｒｒInvincibleInvincibleInvincible"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), If-Then-Else((Local Player).toggle_invincible, Value In Array(String Split(Custom String("ＴＬＥｒｒ | On | On | On"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Empty Array))), Right, -154, Null, Null, If-Then-Else((Local Player).toggle_invincible, Evaluate Once(Value In Array(Global.ColorConfig, 6)), Evaluate Once(Value In Array(Global.ColorConfig, 5))), Visible To String and Color, Default Visibility);
        Create HUD Text(First Of(True), Null, If-Then-Else((Local Player).toggle_guide, Empty Array, Custom String("{0}{1}{2}", If-Then-Else((Local Player).toggle_invincible, Ability Icon String(Hero(바티스트), Button(Ability 2)), Empty Array), If-Then-Else((Local Player).toggle_practice, Ability Icon String(Hero(D.Va), Button(Ultimate)), Empty Array), If-Then-Else((Local Player).toggle_invisible, Ability Icon String(Hero(솜브라), Button(Ability 1)), Empty Array))), Custom String("{0} {1} | {2} HUD", Value In Array(String Split(Custom String("ＴＬＥｒｒHoldHoldHold"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Secondary Fire)), Value In Array(String Split(Custom String("ＴＬＥｒｒToggleToggleToggle"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))), Right, -161, Null, Value In Array(Global.ColorConfig, 5), Value In Array(Global.ColorConfig, 5), Visible To and String, Default Visibility);
        ...
        End;
        If(Global.CompMode);
            Create HUD Text(Filtered Array(All Players(All Teams), (Current Array Element).comp_instructionHud), Custom String("                                                                                                                           "), Null, Null, Top, -181, Color(흰색), Null, Null, Visible To, Default Visibility);
            If(First Of(Global.instructiontext));
                Create HUD Text(Filtered Array(All Players(All Teams), (Current Array Element).comp_instructionHud), Null, Null, First Of(Global.instructiontext), Top, -180, Null, Null, Color(흰색), Visible To, Default Visibility);
            End;
            If(Value In Array(Global.instructiontext, True));
                Create HUD Text(Filtered Array(All Players(All Teams), (Current Array Element).comp_instructionHud), Null, Null, Value In Array(Global.instructiontext, True), Top, -179, Null, Null, Color(흰색), Visible To, Default Visibility);
            End;
            If(Value In Array(Global.instructiontext, 2));
                Create HUD Text(Filtered Array(All Players(All Teams), (Current Array Element).comp_instructionHud), Null, Null, Value In Array(Global.instructiontext, 2), Top, -178, Null, Null, Color(흰색), Visible To, Default Visibility);
            End;
            If(Value In Array(Global.instructiontext, 3));
                Create HUD Text(Filtered Array(All Players(All Teams), (Current Array Element).comp_instructionHud), Null, Null, Value In Array(Global.instructiontext, 3), Top, -177, Null, Null, Color(흰색), Visible To, Default Visibility);
            End;
            Create HUD Text(Filtered Array(All Players(All Teams), (Current Array Element).comp_instructionHud), Custom String("                                   Press {0} to start                                ", Input Binding String(Button(Interact))), Null, Null, Top, -176, Color(흰색), Null, Null, Visible To and String, Default Visibility);
        Else If(Not(Global.EditorOn));
            Create HUD Text((Local Player).toggle_guide, Null, Null, Custom String("{0} {1} | {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒHoldHoldHold"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Ability 2)), Custom String("{0}{1}", Value In Array(String Split(Custom String("ＴＬＥｒｒInvisibleInvisibleInvisible"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), If-Then-Else((Local Player).toggle_invisible, Value In Array(String Split(Custom String("ＴＬＥｒｒ | On | On | On"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Empty Array))), Right, -158, Null, Null, If-Then-Else((Local Player).toggle_invisible, Evaluate Once(Value In Array(Global.ColorConfig, 6)), Evaluate Once(Value In Array(Global.ColorConfig, 5))), Visible To String and Color, Default Visibility);
            Create HUD Text((Local Player).toggle_guide, Null, Null, Custom String("{0} + {1} | {2}", Input Binding String(Button(Ultimate)), Input Binding String(Button(Melee)), Custom String("{0}{1}", Value In Array(String Split(Custom String("ＴＬＥｒｒPracticePracticePractice"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), If-Then-Else((Local Player).toggle_practice, Custom String(" | ({0})", (Local Player).checkpoint_practice), Empty Array))), Right, -153, Null, Null, If-Then-Else((Local Player).toggle_practice, Evaluate Once(Value In Array(Global.ColorConfig, 6)), Evaluate Once(Value In Array(Global.ColorConfig, 5))), Visible To String and Color, Default Visibility);
            Create HUD Text(First Of(And((Local Player).toggle_practice, (Local Player).toggle_guide)), Null, Custom String("{0} + {1} | {2}", Input Binding String(Button(Crouch)), Input Binding String(Button(Primary Fire)), Custom String("{0}\\n{1} + {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒNext LevelNext LevelNext Level"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Crouch)), Custom String("{0} | {1}\\n{2}", Input Binding String(Button(Secondary Fire)), Value In Array(String Split(Custom String("ＴＬＥｒｒPrevious LevelPrevious LevelPrevious Level"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Custom String("{0} | {1}", Input Binding String(Button(Interact)), Value In Array(String Split(Custom String("ＴＬＥｒｒRestart PracticeRestart PracticeRestart Practice"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))))))), Null, Right, -152, Null, Evaluate Once(Value In Array(Global.ColorConfig, 6)), Null, Visible To String and Color, Default Visibility);
            Skip(True);
        Else;
            //spectateHud:
            Create HUD Text((Local Player).toggle_guide, Null, Null, Custom String("{0} {1} | {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒHoldHoldHold"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Interact)), Custom String("{0}{1}", Value In Array(String Split(Custom String("ＴＬＥｒｒSpectateSpectateSpectate"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), If-Then-Else((Local Player).toggle_spectate, Value In Array(String Split(Custom String("ＴＬＥｒｒ | On | On | On"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Empty Array))), Right, -155, Null, Null, If-Then-Else((Local Player).toggle_spectate, Evaluate Once(Value In Array(Global.ColorConfig, 6)), Evaluate Once(Value In Array(Global.ColorConfig, 5))), Visible To String and Color, Default Visibility);
    }
}
...
rule ("Huds | Leaderboard") {
    ...
    action {
        ...
        Create HUD Text((Local Player).toggle_guide, Null, Custom String(" \\n{0} {1} {0}", Icon String(Flag), Value In Array(String Split(Custom String("ＴＬＥｒｒTop 5Top 5Top 5"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))), Null, Right, -141, Null, Color(흰색), Null, Visible To and String, Visible Always);
        Set Global Variable(LeaderBoardHuds, Last Text ID);
        Create HUD Text(First Of(True), Hero Icon String(Hero(겐지)), First Of(First Of(Global.LeaderBoardFull)), Last Of(First Of(Global.LeaderBoardFull)), Right, -140, Color(Red), Color(Red), Color(Red), Visible To, Visible Always);
        Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
        If(Value In Array(Global.LeaderBoardFull, True));
            Create HUD Text(First Of(True), Hero Icon String(Hero(겐지)), First Of(Value In Array(Global.LeaderBoardFull, True)), Last Of(Value In Array(Global.LeaderBoardFull, True)), Right, -139, Color(Orange), Color(Orange), Color(Orange), Visible To, Visible Always);
            Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
            If(Value In Array(Global.LeaderBoardFull, 2));
                Create HUD Text(First Of(True), Hero Icon String(Hero(겐지)), First Of(Value In Array(Global.LeaderBoardFull, 2)), Last Of(Value In Array(Global.LeaderBoardFull, 2)), Right, -138, Color(Yellow), Color(Yellow), Color(Yellow), Visible To, Visible Always);
                Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
                If(Value In Array(Global.LeaderBoardFull, 3));
                    Create HUD Text(First Of(True), Hero Icon String(Hero(겐지)), First Of(Value In Array(Global.LeaderBoardFull, 3)), Last Of(Value In Array(Global.LeaderBoardFull, 3)), Right, -137, Color(Lime Green), Color(Lime Green), Color(Lime Green), Visible To, Visible Always);
                    Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
                    If(Value In Array(Global.LeaderBoardFull, 4));
                        Create HUD Text(First Of(True), Hero Icon String(Hero(겐지)), First Of(Value In Array(Global.LeaderBoardFull, 4)), Last Of(Value In Array(Global.LeaderBoardFull, 4)), Right, -136, Color(Green), Color(Green), Color(Green), Visible To, Visible Always);
                        Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
                    End;
                End;
            End;
        End;
        Create HUD Text(If-Then-Else(Evaluate Once(And(Global.CompMode, Not(Global.CompTime))), True, (Local Player).toggle_leaderboard), Custom String("　　　　 {0} {1} {0} 　　　　\\n　　　　　　　　　　　　　　　　　　{2}", Icon String(Flag), Value In Array(String Split(Custom String("ＴＬＥｒｒLeaderboardLeaderboardLeaderboard"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Evaluate Once(Global.LeaderBoardRemake)), Null, Null, Top, -165, Color(흰색), Null, Null, Visible To and String, Default Visibility);
        Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
...
rule ("Huds | Each Player") {
    ...
    action {
        ...
        Create HUD Text(Event Player, Null, If-Then-Else((Event Player).toggle_practice, Custom String("{0} {1} sec", Value In Array(String Split(Custom String("ＴＬＥｒｒPractice Time:Practice Time:Practice Time:"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), (Event Player).timer_practice), Empty Array), Custom String("{0} {1} sec                                                                                                ", Value In Array(String Split(Custom String("ＴＬＥｒｒTime:Time:Time:"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), (Event Player).timer_normal), Left, -196, Null, Color(회색), Value In Array(Global.ColorConfig, 3), String, Default Visibility);
        Create HUD Text(If-Then-Else((Event Player).toggle_leaderboard, Null, Event Player), If-Then-Else((Event Player).preview_array1, Custom String(" {0} ({1}/{2}", If-Then-Else((Event Player).preview_i, If-Then-Else(Compare((Event Player).preview_i, <=, Count Of((Event Player).cache_bouncePosition)), Value In Array(String Split(Custom String("ＴＬＥｒｒOrbOrbOrb"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Value In Array(String Split(Custom String("ＴＬＥｒｒPortalPortalPortal"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))), Value In Array(String Split(Custom String("ＴＬＥｒｒCheckpointCheckpointCheckpoint"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))))), Add((Event Player).preview_i, True), Custom String("{0})\\n―――――――――――\\n {1}\\n", Count Of((Event Player).preview_array1), If-Then-Else(And(Compare((Event Player).preview_i, <=, Count Of((Event Player).cache_bouncePosition)), (Event Player).preview_i), Custom String("{0} {1} {2}", If-Then-Else(Value In Array(Global.TQ5, Value In Array((Event Player).preview_array2, (Event Player).preview_i)), Ability Icon String(Hero(겐지), Button(Ultimate)), Empty Array), If-Then-Else(Value In Array(Global.TQ6, Value In Array((Event Player).preview_array2, (Event Player).preview_i)), Ability Icon String(Hero(겐지), Button(Ability 1)), Empty Array), Custom String("{0} {1}", If-Then-Else(Value In Array(Global.BounceToggleLock, Value In Array((Event Player).preview_array2, (Event Player).preview_i)), Icon String(Warning), Empty Array), If-Then-Else(Compare(Value In Array(Global.EditMode, Value In Array((Event Player).preview_array2, (Event Player).preview_i)), >, Null), Icon String(Arrow: Up), If-Then-Else(Compare(Value In Array(Global.EditMode, Value In Array((Event Player).preview_array2, (Event Player).preview_i)), <, Null), Icon String(Arrow: Down), Empty Array)))), If-Then-Else((Event Player).preview_i, If-Then-Else(Last Of(Value In Array((Event Player).preview_array2, (Event Player).preview_i)), Custom String("{0} {1}", Value In Array(String Split(Custom String("ＴＬＥｒｒPortal ExitPortal ExitPortal Exit"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Value In Array((Event Player).preview_array2, (Event Player).preview_i)), Custom String("{0} {1}", Value In Array(String Split(Custom String("ＴＬＥｒｒPortal StartPortal StartPortal Start"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Value In Array((Event Player).preview_array2, (Event Player).preview_i))), (Event Player).banString)))), Empty Array), If-Then-Else((Event Player).preview_array1, Empty Array, Custom String("{0}{1} {2}", If-Then-Else(And((Event Player).toggle_guide, (Event Player).banString), Custom String("{0}\\n", (Event Player).banString), Empty Array), Value In Array(String Split(Custom String("ＴＬＥｒｒLevelLevelLevel"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Custom String("{0} / {1}", (Event Player).checkpoint_current, Subtract(Count Of(Global.A), True)))), If-Then-Else(And((Event Player).cache_bounceMaxLocks, Not((Event Player).preview_array1)), Custom String("{0} {1} / {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒ{0} Orbs{0} Orbs{0} Orbs", Value In Array(Global.ColorConfig, 16)), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Count Of((Event Player).cache_collectedLocks), (Event Player).cache_bounceMaxLocks), Empty Array), Top, -172, Value In Array(Global.ColorConfig, 4), Value In Array(Global.ColorConfig, 4), Value In Array(Global.ColorConfig, 16), Visible To and String, Default Visibility);
...
rule ("Huds | Addons") {
    ...
    action {
        ...
        If(Compare((All Players(All Teams)).addon_toggle3rdPov, <=, True));
            Create HUD Text((Local Player).toggle_guide, Null, Null, Custom String("{0} {1} + {2}", Value In Array(String Split(Custom String("ＴＬＥｒｒHoldHoldHold"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Input Binding String(Button(Crouch)), Custom String("{0} | {1}{2}", Input Binding String(Button(Jump)), Value In Array(String Split(Custom String("ＴＬＥｒｒ3rd Person3rd Person3rd Person"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), If-Then-Else((Local Player).addon_toggle3rdPov, Value In Array(String Split(Custom String("ＴＬＥｒｒ | On | On | On"), Global.__overpyTranslationHelper__), Absolute Value(Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array)))), Empty Array))), Right, -159, Null, Null, If-Then-Else((Local Player).addon_toggle3rdPov, Evaluate Once(Value In Array(Global.ColorConfig, 6)), Evaluate Once(Value In Array(Global.ColorConfig, 5))), Visible To String and Color, Default Visibility);
    }
}
...
rule ("Addon | Pre-set control map portal - toggled on via workshop settings") {
    ...
    action {
        ...
        Else If(Compare(Current Map, ==, Map(일리오스)));
        ...
        Else If(Or(Compare(Current Map, ==, Map(리장 타워)), Compare(Current Map, ==, Map(리장 타워 설날))));
        ...
        Else If(Compare(Current Map, ==, Map(네팔)));
        ...
        Else If(Compare(Current Map, ==, Map(오아시스)));
        ...
        Else If(Compare(Current Map, ==, Map(남극 반도)));
        ...
        Else If(Compare(Current Map, ==, Map(사모아)));
...
rule ("Addon | Little destructo - fence breaker") {
    ...
    action {
        ...
        Modify Global Variable(MapVectorArray, Append To Array, If-Then-Else(Compare(Current Game Mode, ==, Game Mode(깃발 뺏기)), Array(Flag Position(Team 1), Flag Position(Team 2)), If-Then-Else(Array Contains(Array(Game Mode(팀 데스매치), Game Mode(데스매치)), Current Game Mode), First Of(Spawn Points(All Teams)), If-Then-Else(And(First Of(Payload Position), Not(Add(Objective Position(True), Objective Position(2)))), Payload Position, Array(Objective Position(False), Objective Position(True), Objective Position(2))))));
        ...
        While(Count Of(Global.MapVectorArray));
            ...
            투사체 생성(구형 투사체, Null, First Of(Global.MapVectorArray), Down, To World, Heal, Team 1, 0, 0, 30, Good Explosion, Explosion Sound, 1, 1, 0, 0, 0, 0);
...
rule ("Addon | SUB Basic Map Validator") {
    ...
    action {
        ...
        Create Dummy Bot(Hero(아나), If-Then-Else(Compare(Number Of Slots(Team 1), <, Number Of Slots(Team 2)), Team 1, Team 2), -1, First Of(Global.A), Null);
...
rule ("☞ Credits and Colors here - 作者代码HUD颜色 <---- INSERT HERE / 在这输入") {
    ...
    action {
        ...
        "time  hud   -   单关用时HUD"
        Set Global Variable At Index(ColorConfig, 3, Color(흰색));
        "level hud   -   关卡HUD"
        Set Global Variable At Index(ColorConfig, 4, Color(흰색));
        "command hud   -   指令HUD"
        Set Global Variable At Index(ColorConfig, 5, Color(흰색));
        ...
        "portals   -   自定义 传送门"
        Set Global Variable At Index(ColorConfig, 17, Color(흰색));
    }
}
...
disabled rule ("Addon | Custom difficulty hud  - 自定义难度hud <---- INSERT HERE / 在这输入") {
    ...
    action {
        ...
        Create HUD Text(First Of(True), If-Then-Else(Last Of(Global.Difficultyhud), If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("游戏测试"), Custom String("Playtest")), Empty Array), Custom String("enter custom difficulty here"), Null, Top, -173, Color(Blue), Color(Green), Null, Visible To and String, Default Visibility);
    }
}
...
disabled rule ("Addon | Title Data - 标题数据 <---- EDIT ME / 在此处编辑") {
    ...
    action {
        ...
        "color\\n颜色"
        Set Global Variable At Index(TitleData, 2, Array(Color(Lime Green), Color(흰색), Color(Yellow), Color(Orange), Color(Purple), Color(Red)));
    }
}
...
disabled rule ("Addon | Group up - Map Data") {
    ...
    action {
        ...
        Create In-World Text(Filtered Array(All Players(All Teams), Compare((Current Array Element).checkpoint_current, ==, 777)), Custom String("{0} {1} {0}", Ability Icon String(Hero(겐지), Button(Ultimate)), If-Then-Else(Compare(String("Oof"), ==, Custom String("噢")), Custom String("待在这里"), Custom String("group up"))), Vector(True, True, True), 1.5, Do Not Clip, Visible To and String, Color(Orange), Default Visibility);
        "replace 777 with checkpoint number\\nreplace vector 0,0,0 with orb position\\n3.5 is the radius"
