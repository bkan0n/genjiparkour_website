...
if (!headers_sent()) {
    header("Content-Security-Policy: default-src 'self'; img-src 'self' https://cdn.discordapp.com data:; script-src 'self' 'unsafe-inline' https://ajax.googleapis.com https://code.jquery.com https://cdn.jsdelivr.net https://kit.fontawesome.com https://youtube.com https://youtu.be https://stackpath.bootstrapcdn.com https://cdnjs.cloudflare.com; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://kit.fontawesome.com https://use.fontawesome.com https://stackpath.bootstrapcdn.com; font-src 'self' https://cdnjs.cloudflare.com https://fonts.gstatic.com https://use.fontawesome.com https://kit.fontawesome.com https://stackpath.bootstrapcdn.com; frame-src 'self' https://www.youtube.com; connect-src 'self' https://test.genji.pk https://genji.pk; frame-ancestors 'none'; base-uri 'self';");
