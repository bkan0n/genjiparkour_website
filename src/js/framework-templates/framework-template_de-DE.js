...
export const frameworkTemplate = `einstellungen
{
	hauptregeln
	{
		Modusname: "Genji Parkour - 源氏跑酷 - v1.10.3G"
...
regel ("<tx0C00000000001344> Parkour v1.10.3G <tx0C00000000001344>") {
    event {
        Ongoing - Global;
    }
}
