...
<div class="settings-modal">
    <div class="settings-container">
        ...
        <div class="settings-tabs">
            <button class="settings-tab active" data-target="overwatch-section">
                <?= htmlspecialchars($translations['settings']['tab_overwatch'] ?? 'Overwatch usernames') ?>
            </button>
            <button class="settings-tab" data-target="notifications-section">
                <?= htmlspecialchars($translations['settings']['tab_notifications'] ?? 'Notifications') ?>
            </button>
        </div>
        ...
        <div class="settings-section" id="overwatch-section" style="display: block;">
            <div class="settings-overwatch">
                ...
                <div id="overwatch-usernames-list"></div>
            </div>
        </div>
